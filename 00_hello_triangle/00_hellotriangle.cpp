...
int main() {
  ...
  g_window = glfwCreateWindow(800,600 , "Hello Triangle", NULL, NULL);
  if (!g_window)
    {
      glfwTerminate();
      return -1;
  ...
  GLfloat points[] = { -0.25f, 0.25f, 0.0f,     //V0
                       0.0f, -0.5f, 0.0f,    //V1
                       -0.5f, -0.5f, 0.0f }; //V2

  GLfloat points2[] = { 0.25f, 0.25f, 0.0f,     //V0
                       0.5f, -0.5f, 0.0f,    //V1
                       0.0f, -0.5f, 0.0f }; //V2
 ...
 GLuint colours_vbo;
  ...
  parse_file_into_str( "test_fs2.glsl", fragment_shader2, 1024 * 256);
  ...
  while ( !glfwWindowShouldClose( g_window ) ) {
    ...
    float xMove = sin(timeValue) / 2.0f + 0.5f;
    glUniform1f(glGetUniformLocation(shader_programme, "xMove"), -(xMove / 2));
    ...
    // update shader uniform
    glUniform1f(glGetUniformLocation(shader_programme2, "xMove"), (xMove/2));
